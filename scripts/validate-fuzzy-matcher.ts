...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 549 || verification.requiredComponentCount !== 549) {
      throw new Error(`Expected exactly 549 components, got ${verification.componentCount}`);
    }
