...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 419 || verification.requiredComponentCount !== 419) {
      throw new Error(`Expected exactly 419 components, got ${verification.componentCount}`);
    }
