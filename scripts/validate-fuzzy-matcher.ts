...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 424 || verification.requiredComponentCount !== 424) {
      throw new Error(`Expected exactly 424 components, got ${verification.componentCount}`);
    }
