...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 529 || verification.requiredComponentCount !== 529) {
      throw new Error(`Expected exactly 529 components, got ${verification.componentCount}`);
    }
