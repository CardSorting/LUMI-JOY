...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 499 || verification.requiredComponentCount !== 499) {
      throw new Error(`Expected exactly 499 components, got ${verification.componentCount}`);
    }
