...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 539 || verification.requiredComponentCount !== 539) {
      throw new Error(`Expected exactly 539 components, got ${verification.componentCount}`);
    }
