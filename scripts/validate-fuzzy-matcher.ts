...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 474 || verification.requiredComponentCount !== 474) {
      throw new Error(`Expected exactly 474 components, got ${verification.componentCount}`);
    }
