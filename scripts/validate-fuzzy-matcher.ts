...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 479 || verification.requiredComponentCount !== 479) {
      throw new Error(`Expected exactly 479 components, got ${verification.componentCount}`);
    }
