...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 459 || verification.requiredComponentCount !== 459) {
      throw new Error(`Expected exactly 459 components, got ${verification.componentCount}`);
    }
