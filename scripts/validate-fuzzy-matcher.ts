...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 504 || verification.requiredComponentCount !== 504) {
      throw new Error(`Expected exactly 504 components, got ${verification.componentCount}`);
    }
