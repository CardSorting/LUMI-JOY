...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 404 || verification.requiredComponentCount !== 404) {
      throw new Error(`Expected exactly 404 components, got ${verification.componentCount}`);
    }
