...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 439 || verification.requiredComponentCount !== 439) {
      throw new Error(`Expected exactly 439 components, got ${verification.componentCount}`);
    }
