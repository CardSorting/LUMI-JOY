...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 399 || verification.requiredComponentCount !== 399) {
      throw new Error(`Expected exactly 399 components, got ${verification.componentCount}`);
    }
