...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 449 || verification.requiredComponentCount !== 449) {
      throw new Error(`Expected exactly 449 components, got ${verification.componentCount}`);
    }
