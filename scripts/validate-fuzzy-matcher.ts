...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 534 || verification.requiredComponentCount !== 534) {
      throw new Error(`Expected exactly 534 components, got ${verification.componentCount}`);
    }
