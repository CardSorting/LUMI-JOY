...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 454 || verification.requiredComponentCount !== 454) {
      throw new Error(`Expected exactly 454 components, got ${verification.componentCount}`);
    }
