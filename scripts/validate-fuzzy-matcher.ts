...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 414 || verification.requiredComponentCount !== 414) {
      throw new Error(`Expected exactly 414 components, got ${verification.componentCount}`);
    }
