...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 554 || verification.requiredComponentCount !== 554) {
      throw new Error(`Expected exactly 554 components, got ${verification.componentCount}`);
    }
