...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 469 || verification.requiredComponentCount !== 469) {
      throw new Error(`Expected exactly 469 components, got ${verification.componentCount}`);
    }
