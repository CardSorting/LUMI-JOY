...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 494 || verification.requiredComponentCount !== 494) {
      throw new Error(`Expected exactly 494 components, got ${verification.componentCount}`);
    }
