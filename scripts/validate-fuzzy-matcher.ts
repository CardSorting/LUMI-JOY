...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 556 || verification.requiredComponentCount !== 556) {
      throw new Error(`Expected exactly 556 components, got ${verification.componentCount}`);
    }
