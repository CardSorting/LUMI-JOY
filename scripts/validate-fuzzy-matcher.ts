...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 544 || verification.requiredComponentCount !== 544) {
      throw new Error(`Expected exactly 544 components, got ${verification.componentCount}`);
    }
