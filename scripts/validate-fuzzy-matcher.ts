...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 409 || verification.requiredComponentCount !== 409) {
      throw new Error(`Expected exactly 409 components, got ${verification.componentCount}`);
    }
