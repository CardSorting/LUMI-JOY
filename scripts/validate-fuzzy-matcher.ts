...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 489 || verification.requiredComponentCount !== 489) {
      throw new Error(`Expected exactly 489 components, got ${verification.componentCount}`);
    }
