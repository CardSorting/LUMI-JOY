...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 464 || verification.requiredComponentCount !== 464) {
      throw new Error(`Expected exactly 464 components, got ${verification.componentCount}`);
    }
