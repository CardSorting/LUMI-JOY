...
async function runValidationSuite() {
  ...
  try {
    ...
    if (verification.componentCount !== 484 || verification.requiredComponentCount !== 484) {
      throw new Error(`Expected exactly 484 components, got ${verification.componentCount}`);
    }
