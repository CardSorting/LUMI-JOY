...
async function main(): Promise<void> {
  ...
  assert(smoke.baseline.highestRecordedPass === CURRENT_EVOLUTION_BASELINE.highestRecordedPass, "Runtime baseline did not advance beyond the legacy Pass 105 ceiling");
