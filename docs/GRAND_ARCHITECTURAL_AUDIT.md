...
> **Generated At**: 2026-08-16T08:14:49.727Z
...
| Mean heterogeneous case latency | 72.77 ms | observed |
| Workload throughput | 13.74 cases/sec | observed |

## Runtime Smoke Evidence

| Category | Capability | Duration | Status | Evidence |
|---|---|---:|---|---|
| composition | Current evolution capabilities are composed | 0.06 ms | PASS | 382 required capabilities across 382 components |
...
| execution | Local frame commits an explicit successful outcome | 0.97 ms | PASS | frame 1 completed in 0.61 ms |
...
| Performance SLA: Execution Throughput | 7245.3 frames/sec | >= 1000 frames/sec | PASS |
