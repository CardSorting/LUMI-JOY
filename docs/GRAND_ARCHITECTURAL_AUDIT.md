...
> **Generated At**: 2026-08-16T08:36:02.402Z
...
| Mean heterogeneous case latency | 72.20 ms | observed |
| Workload throughput | 13.85 cases/sec | observed |
...
| architecture | Core abstract contracts remain connected | 0.12 ms | PASS | agent, session, hands, ears, and tool-registry contracts verified |
| execution | Local frame commits an explicit successful outcome | 0.96 ms | PASS | frame 1 completed in 0.63 ms |
| state | Snapshot rewind restores frame and message state | 0.34 ms | PASS | restored frame 1 with 2 messages |
| governance | Completion gate fails closed without evaluated evidence | 0.49 ms | PASS | 5 fail-closed states rejected; 2/2 evaluated required criteria accepted |
...
| governance | Strategic integrity audit contract is complete | 0.05 ms | PASS | architect, critic, and SRE review sections verified |
...
| Performance SLA: Execution Throughput | 7793.44 frames/sec | >= 1000 frames/sec | PASS |
