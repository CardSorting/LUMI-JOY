...
> **Generated At**: 2026-08-16T08:08:33.651Z
...
| Mean heterogeneous case latency | 69.34 ms | observed |
| Workload throughput | 14.42 cases/sec | observed |
...
| architecture | Core abstract contracts remain connected | 0.17 ms | PASS | agent, session, hands, ears, and tool-registry contracts verified |
| execution | Local frame commits an explicit successful outcome | 0.98 ms | PASS | frame 1 completed in 0.61 ms |
...
| Performance SLA: Sub-Millisecond Turn Tick Latency | 0.16 ms | < 1 ms | PASS |
| Performance SLA: Execution Throughput | 6263.88 frames/sec | >= 1000 frames/sec | PASS |
