...
> **Generated At**: 2026-08-16T07:38:44.264Z
...
| Mean heterogeneous case latency | 72.72 ms | observed |
| Workload throughput | 13.75 cases/sec | observed |
...
| execution | Local frame commits an explicit successful outcome | 1.00 ms | PASS | frame 1 completed in 0.62 ms |
...
| safety | Modern command safety and diagnostics are active | 0.25 ms | PASS | interactive editor blocking and port-collision guidance verified |
...
| Performance SLA: Execution Throughput | 7666.48 frames/sec | >= 1000 frames/sec | PASS |
| Performance SLA: State Rewind Latency | 0.02 ms p95 | < 0.1 ms p95 | PASS |
