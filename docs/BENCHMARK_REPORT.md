...
| Total suite duration | 363.62 ms | observed |
| Workload throughput | 13.75 cases/sec | observed |
| Per-minute throughput | 825 cases/min | observed |
...
| TC-03 | Complete Flappy Bird React + TypeScript + Vite Synthesis | completed | 363.24 ms | 8/8 | PASS |
| TC-04 | Slash Command Router Latency | completed | 0.10 ms | — | PASS |
| TC-05 | Snapshot State Rewind Latency | completed | 0.10 ms | — | PASS |
