...
| Total suite duration | 357.79 ms | observed |
...
| TC-02 | VFS File Perception & Reading | completed | 0.15 ms | — | PASS |
| TC-03 | Complete Flappy Bird React + TypeScript + Vite Synthesis | completed | 357.39 ms | 8/8 | PASS |
