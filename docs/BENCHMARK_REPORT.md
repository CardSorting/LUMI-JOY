...
| Total suite duration | 373.12 ms | observed |
| Workload throughput | 13.40 cases/sec | observed |
| Per-minute throughput | 804 cases/min | observed |

## Test Cases

| ID | Case | Outcome | Latency | Assertions | Status |
|---|---|---|---:|---:|---|
| TC-01 | Turn Tick Latency & Fact Storage | completed | 0.05 ms | — | PASS |
| TC-02 | VFS File Perception & Reading | completed | 0.12 ms | — | PASS |
| TC-03 | Complete Flappy Bird React + TypeScript + Vite Synthesis | completed | 372.73 ms | 8/8 | PASS |
| TC-04 | Slash Command Router Latency | completed | 0.11 ms | — | PASS |
| TC-05 | Snapshot State Rewind Latency | completed | 0.11 ms | — | PASS |
