...
| Total suite duration | 342.26 ms | observed |
| Workload throughput | 14.61 cases/sec | observed |
| Per-minute throughput | 877 cases/min | observed |
...
| TC-03 | Complete Flappy Bird React + TypeScript + Vite Synthesis | completed | 341.90 ms | 8/8 | PASS |
