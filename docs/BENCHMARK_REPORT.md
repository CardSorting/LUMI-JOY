...
| Total suite duration | 337.05 ms | observed |
| Workload throughput | 14.83 cases/sec | observed |
| Per-minute throughput | 890 cases/min | observed |
...
| TC-03 | Complete Flappy Bird React + TypeScript + Vite Synthesis | completed | 336.71 ms | 8/8 | PASS |
