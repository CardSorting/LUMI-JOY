 ...
 *
 * Frame-perfect binary snapshotting and O(1) state rollback for Tool Execution Guard Subsystem (Phase 94 / ADR-046).
 */
...
export class ExecutionGuardSnapshotManager {
   ...
   */
  getSnapshot(frameIndex: number): ToolExecutionWorkspaceSnapshot | undefined {
