...
| Complete Flappy Bird React + TypeScript + Vite synthesis | 12/12 files; 8/8 assertions; $351.62\text{ ms}$ observed |
| Monolith Fast-Path Mean Turn Tick Latency | $0.13\text{ ms}$ |
| Deterministic Monolith Throughput | $7902.55\text{ frames/second}$ |
