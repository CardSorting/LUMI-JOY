...
| Complete Flappy Bird React + TypeScript + Vite synthesis | 12/12 files; 8/8 assertions; $348.49\text{ ms}$ observed |
| Monolith Fast-Path Mean Turn Tick Latency | $0.13\text{ ms}$ |
| Deterministic Monolith Throughput | $7751.91\text{ frames/second}$ |
| State Snapshot Restoration ($O(1)$ Rewind p95) | $0.022\text{ ms}$ |
