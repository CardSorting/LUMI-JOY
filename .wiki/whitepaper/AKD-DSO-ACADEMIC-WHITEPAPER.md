...
| Complete Flappy Bird React + TypeScript + Vite synthesis | 12/12 files; 8/8 assertions; $372.73\text{ ms}$ observed |
| Monolith Fast-Path Mean Turn Tick Latency | $0.14\text{ ms}$ |
| Deterministic Monolith Throughput | $6981.83\text{ frames/second}$ |
| State Snapshot Restoration ($O(1)$ Rewind p95) | $0.042\text{ ms}$ |
