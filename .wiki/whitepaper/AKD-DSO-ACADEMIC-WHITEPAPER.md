...
| Complete Flappy Bird React + TypeScript + Vite synthesis | 12/12 files; 8/8 assertions; $348.34\text{ ms}$ observed |
| Monolith Fast-Path Mean Turn Tick Latency | $0.12\text{ ms}$ |
| Deterministic Monolith Throughput | $8603.70\text{ frames/second}$ |
