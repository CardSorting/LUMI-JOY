...
## Baseline Values (as of 2026-08-16T07:54:59.840Z)
...
- Local Frame Throughput: **$7960.17\text{ frames/second}$** (SLA: $\ge 1,000\text{ frames/second}$).
- State Snapshot Rewind Latency: **$0.021\text{ ms p95}$** (SLA: $< 0.1\text{ ms p95}$).
