...
## Baseline Values (as of 2026-08-16T08:02:32.200Z)
...
- Local Frame Throughput: **$7751.91\text{ frames/second}$** (SLA: $\ge 1,000\text{ frames/second}$).
- State Snapshot Rewind Latency: **$0.022\text{ ms p95}$** (SLA: $< 0.1\text{ ms p95}$).
