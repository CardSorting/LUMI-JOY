...
## Baseline Values (as of 2026-08-16T09:11:40.735Z)
...
- Local Frame Throughput: **$8139.71\text{ frames/second}$** (SLA: $\ge 1,000\text{ frames/second}$).
- State Snapshot Rewind Latency: **$0.025\text{ ms p95}$** (SLA: $< 0.1\text{ ms p95}$).
