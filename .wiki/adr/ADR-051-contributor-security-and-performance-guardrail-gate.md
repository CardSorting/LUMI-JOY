...
## Baseline Values (as of 2026-08-16T07:47:23.357Z)
- Composition Manifest: **382/382** required components in OPTIMAL cohesion.
- Fast-Path Mean Turn Tick Latency: **$0.14\text{ ms}$** (SLA: $< 1.0\text{ ms}$).
- Local Frame Throughput: **$6981.83\text{ frames/second}$** (SLA: $\ge 1,000\text{ frames/second}$).
- State Snapshot Rewind Latency: **$0.042\text{ ms p95}$** (SLA: $< 0.1\text{ ms p95}$).
